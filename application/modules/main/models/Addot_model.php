...
class Addot_model extends CI_Model
{
    ...
    public function save_ot()
    {
        ...
        $body .= "<span style='font-size:18px'><b>สถานะคำร้อง : </b></span>&nbsp;<span style='font-size:18px;color:#FF6600;'>" . $getDataToEmail->ot_status . "</span><br>";
    ...
    public function emailApprove($ot_code)
    {
        // Email Zone
        $getDataToEmail = getDataToEmail($ot_code);
        ...
        $body .= "<span style='font-size:18px'><b>สถานะคำร้อง : </b></span>&nbsp;<span style='font-size:18px;color:#006600;'>" . $getDataToEmail->ot_status . "</span><br>";
        ...
        // foreach (getEmailHR()->result_array() as $gue) {
        //     $mail->AddAddress($gue['memberemail']);
        // }
        $mail->AddAddress("chainarong_k@saleecolour.com");
        // $mail->AddCC("chainarong_k@saleecolour.com");
