...
################################################## -->
    <div class="container-fulid bg-white p-3">
      ...
      <form method="post" id="user_form" action="<?= base_url('main/saveot2newMorning') ?>">
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input type="text" name="ot_date_request" id="ot_date_request" class="form-control datepicker" required />
        ...
        <div id="loadrow">
          <input type="text" name="checkdatarow" id="checkdatarow" value="<?= $rs->num_rows() ?>">
        </div>
